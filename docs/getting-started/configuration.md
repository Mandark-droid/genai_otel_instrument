...
Default instrumentors: `openai`, `openrouter`, `cometapi`, `anthropic`, `google.generativeai`, `boto3`, `azure.ai.openai`, `cohere`, `mistralai`, `together`, `groq`, `ollama`, `vllm`, `sglang`, `llamacpp`, `vertexai`, `replicate`, `anyscale`, `sambanova`, `sarvamai`, `elevenlabs`, `langchain`, `langgraph`, `llama_index`, `transformers`, `autogen`, `autogen_agentchat`, `google_adk`, `pydantic_ai`, `openai_agents`, `bedrock_agents`, `crewai`, `smolagents` (3.10+), `litellm` (3.10+)
