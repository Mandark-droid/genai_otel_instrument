...
curl -X PUT $CURL_AUTH "$OPENSEARCH_URL/_ingest/pipeline/genai-ingest-pipeline" \
  ...
  -d '{
  "description": "GenAI OTel Instrumentation Pipeline v2.6 - audio usage fields + current GenAI semconv names.",
  "version": 26,
  "processors": [
    {
      "script": {
...
echo -e "\n\n================================"
echo "OpenSearch setup COMPLETE v2.6"
echo "================================"
echo ""
echo "Pipeline: genai-ingest-pipeline (v2.6)"
echo "Template: genai-jaeger-span-template"
echo ""
echo "NEW in v2.6 - audio usage + current GenAI semconv names:"
