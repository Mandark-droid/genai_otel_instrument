...
- **Databases**: PostgreSQL, MySQL, MongoDB, SQLAlchemy, TimescaleDB, OpenSearch, Elasticsearch
- **Caching**: Redis
- **Message Queues**: Apache Kafka, RabbitMQ (pika)
- **Object Storage**: MinIO (S3-compatible)
- **Vector Databases**: Pinecone, Weaviate, Qdrant, ChromaDB, Milvus, FAISS, LanceDB
...
**Get Involved:**
- Report bugs and request features via [Issues](https://github.com/Mandark-droid/genai_otel_instrument/issues)
- Contribute code via [Pull Requests](https://github.com/Mandark-droid/genai_otel_instrument/pulls)
